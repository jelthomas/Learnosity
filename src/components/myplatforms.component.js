            ...
            if (decoded._id){
                ...
                .then(response => {
                    if (response) {
                        ...
                        console.log("Here1");
                        api.post('/platformFormat/getCreatedPlatforms/'+ response.data.username)
                        .then(all_plat_ids => {
                            console.log("Here2");
                            var platform_formats = all_plat_ids.data.slice(0, all_plat_ids.data.length)
                            console.log(platform_formats);
